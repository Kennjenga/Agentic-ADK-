...
story_generator = LlmAgent(
    ...
    If there's a topic in session state with key 'topic', use that. Otherwise, use the user's current message.""",
    input_schema=None,
...
# --- Optional: Keep the standalone functionality ---
if __name__ == "__main__":
    # This runs only when executed directly, not through ADK Web
